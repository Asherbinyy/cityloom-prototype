...
1. **Immersive Audio Walking Tour:**
   ...
   - **Playback Speed Controller:** Toggle easily between **1.0x**, **1.5x**, and **2.0x** speed.
   - **Collapsible Story Scripts:** Tap **"Show Script"** on any stop to view the complete historical narration text cleanly without cluttering the screen.
...
3. **Gamified 4-Tier Kirkyard Quiz:**
   ...
   - **7 Question Formats:** Single Choice, True/False, Multi-Select (with toggle fix for Q14), Fill in the Blank, Odd One Out, Matching Pairs, and Drag/Tap Ordering.
...
│   └── tour_data.dart        # 4 stops, audio paths, map coordinates, and scripts
├── models/
...
│   ├── intro_screen.dart          # Welcome intro audio and script
│   ├── map_screen.dart            # Interactive map navigation
│   ├── stop_screen.dart           # Stop photograph, audio player, and script
...
│   └── audio_controller.dart      # Web audio playback, seek, and speed toggles
├── theme/
...
│   ├── audio_player_card.dart     # Audio player with speed and expandable script
...
│   ├── credits_dialog.dart        # Project credits & acknowledgments
